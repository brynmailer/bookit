...
class Projects(Resource):
    ...
    def post(self):
        ...
        if req_body['cost'] and req_body['start'] and req_body['end'] and req_body['employer'] and req_body['description']:
            ...
            return dumps(db.projects.find({'_id': ObjectId(project_id)}), json_options=RELAXED_JSON_OPTIONS), 201
        return jsonify({'error': 'Incorrect POST data'}), 400
